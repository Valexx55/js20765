...
@Component({
  selector: 'app-home',//hook o punto de anclaje
  templateUrl: 'home.page.html',//plantilla que es HTML que va dentro del hook
  styleUrls: ['home.page.scss'],//estilo de la plantilla
})
